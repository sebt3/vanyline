...
gardé, réduit au seul périmètre `stop-start`, bloqué sur **WS-13** (champ
`suspended` sur `SandboxSpec`, pas encore démarrée — nouvelle feature à
concevoir, pas encore de design doc).
